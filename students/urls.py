...
from .api_views import (
    ...
    MealActionAPIView,
    AutoGenerateDailyQR,
    WardenMealStatsAPIView,
    OwnerDashboardAPI, AddStaffAPI, TodayAttendanceAPIView, MarkStudentPresentAPIView,
)
...
urlpatterns = [
    ...
    path('auto-generate-qr/', AutoGenerateDailyQR.as_view()),
    path("warden/meal-stats/", WardenMealStatsAPIView.as_view()),
    path("owner/dashboard/", OwnerDashboardAPI.as_view()),
    path("owner/add-staff/", AddStaffAPI.as_view()),
    path("attendance/today/", TodayAttendanceAPIView.as_view()),
    path('attendance/mark-present/', MarkStudentPresentAPIView.as_view(), name='mark-student-present'),
